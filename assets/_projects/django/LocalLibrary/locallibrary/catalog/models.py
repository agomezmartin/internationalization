...
class Book(models.Model):
    ...
    author = models.ForeignKey(_('Author'), on_delete=models.SET_NULL, null=True)
    ...
    language = models.ForeignKey(_('Language'), on_delete=models.SET_NULL, null=True)
...
class BookInstance(models.Model):
    ...
    book = models.ForeignKey(_('Book'), on_delete=models.RESTRICT, null=True)
